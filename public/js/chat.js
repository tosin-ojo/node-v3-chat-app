...
const headerSideTemplate = document.querySelector(
  "#header-side-template"
).innerHTML;
...
socket.on("message", (message) => {
  const html = Mustache.render(messageTemplate, {
    class:
      message.username.toLowerCase() === "admin"
        ? "message__admin"
        : username.toLowerCase() === message.username.toLowerCase()
        ? "message message__reciever"
        : "message",
    username:
      message.username.toLowerCase() === "admin" ? "" : message.username,
